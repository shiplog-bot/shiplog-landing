...
[executive summary here]
  ...
  const userPrompt = `Repository: ${repo}\nPRs merged: ${prs.length}\nCommits: ${commits.length}\n\nGitHub activity:\n${context}\n\nGenerate three versions:\n\n1. DEVELOPER: Technical release notes for developers. Use markdown bullets. Include specific APIs, breaking changes, dependencies, implementation details.\n\n2. USER: User-facing release notes in plain language. Use markdown bullets. Focus on features and improvements visible to end users. Start each bullet with a verb.\n\n3. EXECUTIVE: 2-3 sentence executive summary. High-level business value only.\n\nOutput only the three sections in the exact XML tags shown above.`;
